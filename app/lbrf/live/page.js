...
// import { FaPlay, FaPause, FaVolumeUp, FaVolumeMute, FaArrowDown } from "react-icons/fa";
...
//             if (Hls.isSupported()) {
//                 hls.loadSource('https://cdnstack.internetmultimediaonline.org/ln24/lntoons.stream/chunklist_w1275422486.m3u8');
...
//                 video.src = 'https://cdnstack.internetmultimediaonline.org/ln24/lntoons.stream/chunklist_w1275422486.m3u8';
...
//         'reconnecting': { text: `Reconnecting (${reconnectAttempts})...`, color: 'text-yellow-500' },
...
//                 <h1 className="text-3xl font-bold text-center mb-8">Live Bible Streaming</h1>
...
//                                     <button onClick={() => skip(-10)} className="text-white text-xl">
//                                         <FaRotateLeft />
//                                     </button>
...
//                             <p>Join us for live Bible reading and discussion. Feel free to share your thoughts in the comments section!</p>
//                         </div>
//                     </div>
...
//                                             <div className={`flex-shrink-0 w-10 h-10 rounded-full ${getRandomColor(comment.name)} flex items-center justify-center text-white font-bold`}>
//                                                 {comment.name?.charAt(0).toUpperCase() || 'U'}
//                                             </div>
//                                             <div>
//                                                 <div className="font-semibold">{comment.name || 'Anonymous'}</div>
...
//                             <form onSubmit={handleSubmitComment} className="p-4 border-t space-y-2">
//                                 <div>
//                                     <input
//                                         type="text"
//                                         value={name}
...
//                                         disabled={!commentText.trim() || !name.trim() || connectionStatus !== 'connected'}
//                                     >
//                                         Send
//                                     </button>
//                                 </div>
