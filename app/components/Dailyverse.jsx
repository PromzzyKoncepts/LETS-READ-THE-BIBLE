...
const DailyVerse = () => {
  ...
  return (
    <div>
      {verse && (
        <div className="font-sniglet text-white  flex flex-col justify-start items-start">
          ...
          <div className="font-bubblegum text-base max-w-[35rem] flex items-end justify-items-end text-left">
            <TextAnimation>{verse || "No content available."}</TextAnimation>
          </div>
          <div className="text-[#EEA236]">
            <TextAnimation>{reference}</TextAnimation>
          </div>
        </div>
      )}
    </div>
