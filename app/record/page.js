...
const App = () => {
    ...
    return (
        <div  style={{ backgroundImage: `url(/images/record.jpg)`, backgroundOpacity: '50', objectFit: "fill", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}   className="md:px-28 px-5 pt-24  bg-[#F4C2C2] min-h-screen">
