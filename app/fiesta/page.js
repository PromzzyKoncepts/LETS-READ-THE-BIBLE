  ...
  return (
    <div className="bg-[#d6d6cb] md:pt-24 min-h-screen">
      ...
      <div
        ...
        className="md:w-[85%] flex items-center object-contain justify-center flex-col md:rounded-2xl mx-auto h-36 md:h-64 text-white p-5 md:p-10"
      >
        {user ? (
          <div>
            {user?.fullName && (
              <small className="text-white font-lucky text-center md:text-left md:text-2xl">
            ...
            <p className="text-center md:text-base text-xs font-schoolbell">
              You have successfully registered for the Lovetoons Bible Reading
              Fiesta
            </p>
          </div>
        ) : (
          <div>
            ...
            <p className="text-center font-sniglet">
              <Link className="underline" href="/lbrf">
      ...
      <div className="px-5 md:px-32 pt-5 md:pt-10  md:grid grid-cols-3 flex-col md:flex-row gap-4 md:gap-10 font-sniglet">
        <div className="col-span-2">
          <h2 className="font-lucky text-3xl md:text-5xl text-darkbg">
          ...
          <div className="flex md:hidden justify-center mb-3">
            ...
            >
              {isDownloading
                ? "Downloading..."
                : "Download all Publicity Cards"}
            </button>
          </div>

          <p>
            <span className="text-blue-500 font-jua text-lg md:text-xl">
          ...
          <p className="mt-1">
            ...
            engaging children everywhere to read the Bible. This is more than
            just reading; it's about instilling a consciousness of the Bible
            while fostering a love for the Bible in their hearts.
          </p>
          <p className="mt-1">
            As the Bible lovingly reminds us, "Start children off on the way
            they should go, and even when they are old, they will not turn from
            it" (Proverbs 22:6).
          </p>
          <p className="mt-1">
            Through this wonderful program, children can read a chapter of the
            Old Testament Section of the Bible, record themselves, and share
            their readings with millions of other children. This will enable
            them to learn inspiring truths and engage with the profound messages
            of faith, hope, and love found in the pages of the Bible.
          </p>
          <p className="mt-1">
            Let’s come together to guide our kids on this beautiful journey,
            helping them to discover the love of our Lord Jesus Christ and the
            amazing person of the Holy Spirit. Your involvement can make a
        ...
        <div className="w-full col-span-1 flex flex-col gap-3 mt-5 md:mt-0">
          <Link
            href="/avatar"
            className="bg-gradient-to-bl transition-all duration-200 ease-in-out hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 from-[#FFCDB4] to-[#ED6073] px-5 w-max py-4 rounded-2xl text-slate-800 text-lg font-lucky flex items-center gap-2"
          >
            <IoPersonCircleSharp size={30} />
            Create fiesta avatar
          </Link>
          <Link
            href="/lbrf/picture"
            className="bg-gradient-to-tr transition-all duration-200 ease-in-out hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 from-[#EA8937] to-[#F8C254] px-5 w-max py-4 rounded-2xl text-slate-800 text-lg font-lucky flex items-center gap-2"
          >
          ...
          <Link
            href="/fiesta/upload"
            className="bg-gradient-to-bl transition-all duration-200 ease-in-out hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 from-[#c7c7e0] to-[#8E8EB1] px-5 w-max py-4 rounded-2xl text-slate-800 text-lg font-lucky flex items-center gap-2"
          >
            <IoMdCloudUpload size={30} />
            Select a chapter
          </Link>
          <Link
            href="/fiesta/upload"
            className="bg-gradient-to-tr transition-all duration-200 ease-in-out hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 from-green-500 to-lime-500 px-5 w-max py-4 rounded-2xl  text-lg font-lucky text-white flex items-center gap-2"
          >
            <IoMdCloudUpload size={30} />
            Upload now
          </Link>
          <Link
            href="/record"
            className="bg-gradient-to-tr transition-all duration-200 ease-in-out from-[#0081EE] to-[#88CEDF] px-5 w-max py-4 rounded-2xl text-slate-100 text-lg font-lucky hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 flex items-center gap-2"
          >
            <MdEmergencyRecording size={30} />
            Record and Read
          </Link>
          <Link
            href="/lbrf"
            className="bg-gradient-to-tr transition-all duration-200 ease-in-out hover:border-2 hover:border-white hover:shadow-lg hover:shadow-gray-700 shadow-lg shadow-gray-500 from-fuchsia-500 to-fuchsia-600 px-5 w-max py-4 rounded-2xl text-white text-lg font-lucky flex items-center gap-2"
          >
          ...
          {card.map((item) => (
            <div key={item.title} className="relative">
              ...
              <a
                href={item.src}
                download={item.title}
                className="absolute top-2 text-white right-2 rounded-full bg-slate-600 p-3"
              >
