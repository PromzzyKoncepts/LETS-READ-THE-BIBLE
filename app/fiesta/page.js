...
const Page = () => {
  ...
  return (
    <div className="bg-[#d6d6cb] md:pt-24 min-h-screen">
      <div style={{ backgroundImage: `url(/images/congrats.jpg)`, backgroundRepeat: "no-repeat" }} className="md:w-[85%] flex items-center justify-center flex-col md:rounded-2xl mx-auto h-36 md:h-64 text-white p-5 md:p-10">
        <div>
      ...
      <div className="">
        ...
        <h2 className="text-xl md:text-3xl font-lucky text-[#FD3006] py-1">A 24-HR BIBLE READING RENDE-VOUS</h2>
      ...
      <a href="https://lovetoons.org/sponsor.php" target="_blank"><Image src="/images/sponsor.png" alt="sponsor LBR" className="mx-auto pt-10 md:pt-16 w-full md:w-[85%]" width={1000} height={1000} /></a>
